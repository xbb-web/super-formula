...
export const NumberFunctions = {
   ...
   ADD: function (num1: MathType = 0, num2: MathType = 0, n?: number): MathType | string {
      return n ? Number(format(add(num1, num2), { notation: 'fixed', precision: n })) : add(num1, num2);
   },
   /**
   ...
   SUBTRACT: function (
      ...
      return n ? Number(format(subtract(num1, num2), { notation: 'fixed', precision: n })) : subtract(bignumber(num1), bignumber(num2));
   },
   /**
   ...
   MULTIPLY: function (
      ...
      return n ? Number(format(multiply(num1, num2), { notation: 'fixed', precision: n })) : multiply(num1, num2);
   },
   /**
   ...
   DIVIDE: function (
      ...
      return n ? Number(format(divide(num1, num2), { notation: 'fixed', precision: n })) : divide(num1, num2);
   },
